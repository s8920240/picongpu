...
struct Size_t : public PMacc::math::CT::Vector<mpl::integral_c<size_t, x>, mpl::integral_c<size_t, y>,mpl::integral_c<size_t, z> >
{};

template<>
struct Size_t<> : public PMacc::math::CT::Vector<>
{};

template<size_t x>
struct Size_t<x> : public PMacc::math::CT::Vector<mpl::integral_c<size_t, x> >
{};

template<size_t x, size_t y>
struct Size_t<x, y> : public PMacc::math::CT::Vector<mpl::integral_c<size_t, x>,
