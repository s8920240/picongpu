...
struct UInt : public PMacc::math::CT::Vector<mpl::integral_c<uint32_t, x>,
                                                   mpl::integral_c<uint32_t, y>,
                                                   mpl::integral_c<uint32_t, z> >
{};

template<>
struct UInt<> : public PMacc::math::CT::Vector<>
{};

template<uint32_t x>
struct UInt<x> : public PMacc::math::CT::Vector< mpl::integral_c<uint32_t, x> >
{};

template<uint32_t x, uint32_t y>
struct UInt<x, y> : public PMacc::math::CT::Vector<mpl::integral_c<uint32_t, x>,
                                                mpl::integral_c<uint32_t, y> >
{};
